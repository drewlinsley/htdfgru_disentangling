...
GPU="1"
CKPTCSV="data_to_process_for_jk/inv_main_synth_experiment_data/inv_main_synth_experiment_data_max_ckpts_only.csv"
MODELCSV="data_to_process_for_jk/inv_main_synth_experiment_data/inv_main_synth_experiment_data_max_models_only.csv"
TRAINDSCSV="data_to_process_for_jk/inv_main_synth_experiment_data/inv_main_synth_experiment_data_max_trainds_only.csv"
declare -a EXPERIMENTS=("v2_synth_connectomics_test_baseline" "v2_synth_connectomics_test_size_1")  #  "v2_synth_connectomics_test_size_2" "v2_synth_connectomics_test_size_3")

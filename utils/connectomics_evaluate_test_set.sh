...
CKPTCSV="data_to_process_for_jk/snemi_experiment_data/snemi_experiment_data_max_ckpts_only.csv"
MODELCSV="data_to_process_for_jk/snemi_experiment_data/snemi_experiment_data_max_models_only.csv"
TRAINDSCSV="data_to_process_for_jk/snemi_experiment_data/snemi_experiment_data_max_trainds_only.csv"
declare -a EXPERIMENTS=("test_snemi_combos" "berson_combos" "fib_combos" "cremi_combos") 

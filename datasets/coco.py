...
class data_processing(object):
    def __init__(self):
        self.output_name = 'coco'
        self.train_path = glob('/media/data_cifs/lakshmi/coco_stuff_train/*.tfrecords')
        self.val_path = glob('/media/data_cifs/lakshmi/coco_stuff_val/*.tfrecords')
        ...
        self.im_size = [448, 448, 3]  # [321, 481, 3]
        ...
        self.val_model_input_image_size = [224, 224, 3]
        self.output_size = [448, 448, 93]  # [321, 481, 1]
        self.label_size = [448, 448, 1]

...
class data_processing(object):
    def __init__(self):
        ...
        self.im_size = [480, 320, 3]  # [321, 481, 3]
        self.model_input_image_size = [480, 320, 3]  # [224, 224, 3]
        self.test_model_input_image_size = [480, 320, 3]
        self.output_size = [240, 160, 128]  # [320, 480, 1]  # [321, 481, 1]
    ...
    def get_files(self):
        ...
        targets = np.load("perturb_viz/BSDS_vgg_cheap_deepest_final_simple_BSDS500_test_2020_08_17_11_46_06_467841.npz", allow_pickle=True)

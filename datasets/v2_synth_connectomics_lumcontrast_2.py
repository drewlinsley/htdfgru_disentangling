...
class data_processing(object):
    def __init__(self):
        self.name = 'shape_connectome_lumcontrast_2'
        self.output_name = 'shape_connectome_lumcontrast_2'
        self.data_name = 'lumcontrast2'
        self.img_dir = 'imgs'
        self.contour_dir = '/media/data_cifs/synth/synth_connectomics/'
        self.im_extension = '.png'
        self.label_regex = r'(?<=length)\d+'
        self.config = Config()
        self.im_size = [500, 500]  # [350, 350]  # 600, 600
    ...
    def get_data(self):
        ...
        val_cutoff = -200
        train_ims = shuffle_images[:val_cutoff]
        train_labels = shuffle_labels[:val_cutoff]

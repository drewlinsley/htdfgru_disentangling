...
class data_processing(object):
    def __init__(self):
        ...
        self.nhot_size = [26]
        self.max_ims = 222
        self.output_size = {'output': 8, 'aux': self.nhot_size[0]}
        self.label_size = self.im_size + [8]
    ...
    def gather_windows(self, volume, label, window_size=256, stride_size=128, affinity=True):
        """Im2Col the data."""

...
class data_processing(object):
    def __init__(self):
        self.name = 'berson_100'
        self.output_name = 'berson_test'
    ...
    def get_data(self):
        ...
        cv_labels[self.folds['train']] = train_labels[..., None]
        cv_labels[self.folds['val']] = val_labels[..., None]
        cv_labels[self.folds['test']] = val_labels[..., None]

...
class data_processing(object):
    def __init__(self):
        ...
        self.pad = 15
        self.im_size = [481 + self.pad, 321 + self.pad, 3]  # [321, 481, 3]
        self.model_input_image_size = [481 + self.pad, 321 + self.pad, 3]  # [224, 224, 3]
        self.test_model_input_image_size = [481 + self.pad, 321 + self.pad, 3]
        self.output_size = [481 + self.pad, 321 + self.pad, 1]  # [321, 481, 1]

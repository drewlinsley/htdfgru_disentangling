...
def get_aux():
    ...
    return {
        'attention': False,  # 'se',  # 'gala',  # 'gala',  # 'gala', se
        'attention_layers': 2,
        'saliency_filter': 5,
        ...
        'image_resize': tf.image.resize_nearest_neighbor,  # resize_nearest_neighbor,
        'bilinear_init': True,
        'nonnegative': True,
...
def v0():
    ...
    features = [16, 24, 48, 24, 16]
    fgru_kernels = [[9, 9], [1, 1], [1, 1], False, False]
...
def v1():
    ...
    ff_kernels = [[False]] + [[3, 3]] * (len(compression) - 1)
    ff_repeats = [False, 4, 4, 4, False, False, False]

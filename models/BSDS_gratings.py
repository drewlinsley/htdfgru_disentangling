...
def v2_big_working():
    ...
    # ar = ['fgru_1', 'fgru_2']  # , 'fgru_3', 'fgru_4']  # Output layer ids
...
def build_model(
    ...
    input_training = False  # training   # training
    readout_training = False  # training  # False
    norm_moments_training = False  # training  # Force instance norm
    norm_params_training = False  # training
    fgru_kernel_training = False  # training
    fgru_param_training = False  # training
    ff_gate_training = False  # training
    fgru_gate_training = False  # training
    remaining_param_training = False  # training

...
from layers.recurrent import recurrent_vgg16_cheap as vgg16
...
def get_aux():
    ...
    return {
        'attention': False,  # 'gala',  # 'gala', 'se', False
        'attention_layers': 1,
        ...
        'while_loop': False,
        'image_resize': tf.image.resize_bilinear,  # resize_nearest_neighbor,
        'bilinear_init': False,
        'nonnegative': False,
        'adaptation': False,

...
def experiment_params():
    ...
    exp['lr'] = [1e-2]
    # exp['train_loss_function'] = ['sigmoid_pearson']  # ['hed_bce']  # ['bsds_bce']
    # exp['val_loss_function'] = ['sigmoid_pearson']  # ['hed_bce']  # ['bsds_bce']  # ['bsds_bce']
    exp['train_loss_function'] = ['weighted_bce']  # ['hed_bce']  # ['bsds_bce']
    exp['val_loss_function'] = ['weighted_bce']  # ['hed_bce']  # ['bsds_bce']  # ['bsds_bce']
